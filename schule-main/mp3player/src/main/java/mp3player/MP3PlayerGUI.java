...
public class MP3PlayerGUI extends JFrame {
    ...
    private JPanel createDashboardPanel() {
        ...
        JButton deletePlaylistBtn = createStyledButton("Löschen", DELETE_COLOR);
        ...
        playlistActionPanel.add(deletePlaylistBtn);
    ...
    private void deletePlaylist() {
        ...
        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Möchten Sie die Playlist '" + selectedName + "' wirklich löschen?",
                "Playlist löschen",
